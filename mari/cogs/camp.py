"""MariCamp — 캠프 견학 이동/복귀와 캠프 세금 통장."""
...
from mari_config import CAMP_LEADER_ROLE_ID, CAMP_ROLE_IDS, CAMP_TREASURY_FILE, CAMP_VISIT_FILE, JEONYUL_ROLE_ID, KST
from mari_settings import has_admin_or_role
from mari_state import record_ledger, record_ledger_many
from mari_storage import atomic_json_save_or_raise, safe_json_load
from mari_utils import chunk_lines, describe_user_error, portfolio_value, report_broken_transaction
from mari_tax import (CAMP_TAX_TYPE, config_to_text, flat_bracket_tax, load_tax_config,
...
class MariCamp(commands.Cog):
    ...
    def _get_economy_cog(self):
        return self.bot.get_cog("MariEconomy")
    ...
    # 🗑️ [정리] 여기 있던 _stock_value_of는 mari_utils.portfolio_value와 하는 일이 같았어요.
