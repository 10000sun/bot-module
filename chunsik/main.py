"""봇 진입점. 실제 기능은 chunsik_*.py와 cogs/ 아래에 나뉘어 있어요.
...
from chunsik_config import BASE_DIR, DISCORD_TOKEN, GUILD_CONFIG_FATAL, GUILD_CONFIG_PATH, intents
from chunsik_alerts import send_alert_sync
...
async def main():
    ...
    #  전부 켜진 상태가 맞습니다. chunsik_config.load_guild_config 참고)
