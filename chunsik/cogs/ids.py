"""ChunsikIds — 게임 아이디 등록/수정/삭제/자동등록 및 아이디 명단 자동 게시."""
...
from chunsik_config import DATA_DIR, ID_PENDING_FILE, KST, RANKS, json_data_files
...
class UnmatchedResolveView(ChunsikView):
...
class ChunsikIds(commands.Cog):
    ...
    def has_permission(self, member: discord.Member) -> bool:
        ...
        # 🗑️ [정리] chunsik_access 레거시 개별 허용 목록 체크는 제거했습니다.
    ...
    def _print_data_status(self):
        ...
        이제 chunsik_config.json_data_files()로 전부 자동 수집하므로 새 파일을 추가해도
