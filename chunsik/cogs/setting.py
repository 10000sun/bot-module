"""ChunsikSetting — 채널/관리자 역할 동적 설정, 기능 정지·재개, 역할 부여."""
...
class RoleGrantView(ChunsikView):
...
class InitialSetupModal(discord.ui.Modal, title="🏷️ 이름 설정"):
    ...
    입력칸을 손으로 나열하지 않고 chunsik_names.NAME_FIELDS를 보고 만들어요. 나중에 받을
...
class ChunsikSetting(commands.Cog):
    ...
    #    서버의 명령 목록에도 "주식/생일 로그"가 그대로 뜹니다.
    #    📌 규칙: 명령 **설명문**에 기능 이름을 나열하지 마세요. 명령은 구성에 따라
    #       빠지는데 설명문의 글자는 안 빠집니다.
