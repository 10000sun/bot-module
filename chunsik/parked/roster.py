...
from chunsik_config import (AFFILIATION_ROLE_IDS, KST, LEVEL_ROLE_IDS,
...
class ChunsikRoster(commands.Cog):
    ...
    # chunsik_config의 CAMP_ROLE_IDS·JEONYUL_ROLE_ID와 **똑같은 값을 한 벌 더** 적어둔 것이었습니다.
